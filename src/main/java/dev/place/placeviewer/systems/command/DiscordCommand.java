...
public class DiscordCommand extends BukkitCommand {
    ...
    public boolean execute(@NotNull final CommandSender sender, @NotNull final String command, @NotNull final String @NotNull [] args) {
        ...
        if (url.isBlank()) {
            sender.sendMessage(Component.text("Discord link is not configured.", NamedTextColor.RED));
            return true;
        }
        ...
        sender.sendMessage(Component.text("Discord: ", NamedTextColor.GOLD).append(link));
        return true;
    }
